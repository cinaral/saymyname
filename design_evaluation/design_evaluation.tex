\documentclass[a4paper, 10pt, DIV=16, parskip = full, twocolumn = false]{scrartcl}
\usepackage{setspace}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{lastpage}
...
\begin{table}
	...
	\begin{tabular}{rS|ccccc}
		\toprule
		Criterion & \text{Weight (\%)} &\text{1-1C1} & \textbf{1-1C2} & \text{1-1C3*}  & \text{1-1C4} & \text{1-1C5} \\
		\midrule
	...
	\begin{tabular}{rS|ccc}
		\toprule
		Criterion & \text{Weight (\%)} &\textbf{1-2C1*} & \text{1-2C2} & \text{1-2C3} \\
		\midrule
		1-2E1 & 34.5 & D & -1 & -1 \\
		1-2E2 & 35.6 & D & -1 & 1  \\
		1-2E3& 4.94 & D & 1 & 1  \\
	...
	\begin{tabular}{rS|ccc}
		\toprule
		Criterion & \text{Weight (\%)} &\textbf{1-3C1*} & \text{1-3C2} & \text{1-3C3}\\
		\midrule
		1-3E1 & 37.2 & D & -1 & -1\\
		1-3E2 & 6.74 & D & -1 & -1 \\
		1-3E3 & 42.6 & D & -1 & -1 \\
	...
	\begin{tabular}{rS|ccc}
		\toprule
		Criterion & \text{Weight (\%)} & \text{1-4C1*} & \textbf{1-4C2} & \text{1-4C3}\\
		\midrule
		1-4E1 & 6.87 & D & -1 & 1 \\
		1-4E2 & 38.9 & D & 1 & 1  \\
		1-4E3 & 38.9 & D & 1 & -1  \\
	...
	\begin{tabular}{rS|ccccc}
		\toprule
		Criterion & \text{Weight (\%)} & \textbf{1-5C1} & \text{1-5C2} & \text{1-5C3*} & \text{1-5C4} & \text{1-5C5} \\
		\midrule
	...
	\begin{tabular}{rS|ccc}
		\toprule
		Criterion & \text{Weight (\%)} & \textbf{1-6C1} & \text{1-6C2*} & \text{1-6C3} \\
		\midrule
		1-6E1 & 9.76 & 1 & D & 0\\
		1-6E2 & 34.1 & 0 & D & 1 \\
		1-6E3 & 31.3 & 1 & D & -1 \\
...
\begin{table}
	...
	\begin{tabular}{rS|ccc}
		\toprule
		Criterion & \text{Weight (\%)} & \textbf{1-7C1} & \text{1-7C2} & \text{1-7C3*} \\
		\midrule
		1-7E1 & 6.70 & -1 & -1 & D \\
		1-7E2 & 49.1 & 1 & 1 & D \\
		1-7E3 & 15.1 & 1 & 1 & D \\
	...
	\begin{tabular}{rS|ccc}
		\toprule
		Criterion & \text{Weight (\%)} & \textbf{2-1C1} & \text{2-1C2*} & \text{2-1C3} \\
		\midrule
		2-1E1 & 8.97 & -1 & D & -1 \\
		2-1E2 & 60.7 & 1 & D & 0\\
		2-1E3 & 30.3 & 1 & D & 0 \\
	...
	\begin{tabular}{rS|ccc}
		\toprule
		Criterion & \text{Weight (\%)} & \textbf{2-2C1*} & \text{2-2C2} & \text{2-2C3} \\
		\midrule
		2-2E1 & 5.91 & D & -1 & -1 \\
		2-2E2 & 10.5 & D & -1 & -1 \\
		2-2E3 & 19.1 & D & 0 & 1 \\
	...
	\begin{tabular}{rS|cc}
		\toprule
		Criterion & \text{Weight (\%)} & \textbf{3-1C1*} & \text{3-1C2}\\
		\midrule
		3-1E1 & 7.68 & D & -1 \\
		3-1E2 & 15.9 & D & -1 \\
		3-1E3 & 26.3 & D & 1 \\
	...
	\begin{tabular}{rS|ccc}
		\toprule
		Criterion & \text{Weight (\%)} & \textbf{4-1C1} & \text{4-1C2*} & \text{4-1C3} \\
		\midrule
		4-1E1 & 6.00 & 1 & D & -1\\
		4-1E2 & 41.4 & 1 & D & 1 \\
		4-1E3 & 24.7 & 1 & D & 0 \\
	...
	\begin{tabular}{rS|cccc}
		\toprule
		Criterion & \text{Weight (\%)} & \text{5-1C1} & \text{5-1C2} & \text{5-1C3*} & \textbf{5-1C4} \\
		\midrule
		5-1E1 & 14.0 & 1 & -1 & D & 1 \\
		5-1E2 & 57.4 & -1 & 1 & D & 1 \\
		5-1E3 & 28.6 & -1 & -1 & D & -1 \\
...
\begin{table}[htp!]	
	...
	\begin{tabular}{rS|cccc}
		\toprule
		Criterion & \text{Weight (\%)} & \textbf{5-2C1} & \textbf{5-2C2} & \text{5-2C3*} & \text{5-2C4} \\
		\midrule
		5-2E1 & 7.65 & 1 & 1 & D & -1 \\
		5-2E2 & 54.3 & 1 & 1 & D & -1 \\
		5-2E3 & 13.6 & 0 & 0 & D & -1 \\
