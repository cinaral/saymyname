	...
	\node [block, below of=subsub13] (subsub14) {Faciliate the movement};
    \node [block, below of=subsub14] (subsub15) {Actuate the movement};
	\node [block, below of=subsub15] (subsub16) {Control the movement};
    ...
    % Draw edges
    \path [line] (header) -| (sub11);
    \path [line] (header) -| (sub12);
    \path [line] (header) -- node {9} (sub13);
    \path [line] (header) -| node[near end] {10} (sub14);
    \path [line] (header) -| (sub15);
    \path [line] (sub11) |- node[near end] {1} (subsub11);
    \path [line] (sub11) |- node[near end] {2} (subsub12);
    \path [line] (sub11) |- node[near end] {3} (subsub13);
    \path [line] (sub11) |- node[near end] {4} (subsub14);
    \path [line] (sub11) |- node[near end] {5} (subsub15);
    \path [line] (sub11) |- node[near end] {6} (subsub16);
    \path [line] (sub12) |- node[near end] {7} (subsub21);
    \path [line] (sub12) |- node[near end] {8} (subsub22);
    \path [line] (sub15) |- node[near end] {11} (subsub51);
    \path [line] (sub15) |- node[near end] {12} (subsub52);
